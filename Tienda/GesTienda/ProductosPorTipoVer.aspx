...
<asp:Content ID="Content2" ContentPlaceHolderID="InfoContenido" runat="server">
    ...
    <div class="contenidosubtitulo" style="text-align: center">Tipos de producto</div>
    ...
    <asp:GridView ID="grdTipos" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdTipo" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" PageSize="5" Width="50%" OnSelectedIndexChanged="grdTipos_SelectedIndexChanged">
    ...
    <div class="contenidosubtitulo" style="text-align: center">Productos</div>
